...
# axis. Both source COGs are absolute per-pixel totals (kg), mass-conserving-
# resampled -- see create_agriculture_zarr.py. This zarr stores the converted
...
#
# v3 (testing): livestock switched from area-weighting a per-hectare rate to
# the same mass-conserving uniform-split resample of an absolute total COG,
# for the same reason as cropland's v2 change.
#
...
land_ghg_inventory_agriculture_zarr_uri = (
    ...
    "cropland_livestock_emissions_v3.zarr"
)
