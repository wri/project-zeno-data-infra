...
#
# v3: livestock switched from our in-house per-animal aggregation to
# Cornell's own pre-aggregated total COG (the in-house aggregation summed
# per-animal `_ALL` files that Cornell confirmed are undercounted for
# several countries, e.g. Australia).
