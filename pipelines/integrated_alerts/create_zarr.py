...
def create_zarr(dataset, version, overwrite=False) -> str:
    """create a full extent zarr file in s3."""
    base_folder = f"{dataset}/{version}/raster/epsg-4326"
    zarr_uri = f"s3://{DATA_LAKE_BUCKET}/{base_folder}/zarr/{dataset}.zarr"
