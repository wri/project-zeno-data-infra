...
def integrated_alerts_area(integrated_zarr_uri: str, integrated_version: str, overwrite=False):
    ...
    datasets = integrated_common_tasks.load_data.with_options(name="integrated-alerts-load_data")(
        integrated_zarr_uri
    )
    ...
    common_tasks.save_result.with_options(
        name="integrated-alerts-save-result"
