...
class GoogleEarthEngineDatasetRepository:
    ...
    EE_ASSETS = {
        ...
        "gross_emissions": lambda: ee.Image("projects/forma-250/assets/gfw_forest_carbon_gross_emissions/gross_emissions_forest_extent_per_hectare_v1_4_2_2001_2024"),
        "gross_removals": lambda: ee.Image("projects/forma-250/assets/gfw_forest_carbon_gross_removals/gross_removals_forest_extent_per_hectare_v1_4_2_2001_2024")
    }
