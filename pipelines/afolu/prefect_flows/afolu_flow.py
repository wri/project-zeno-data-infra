...
def afolu_area(
    ...
    """AFOLU land-flux zonal stats. Each component (vegetation, mineral soil) is
    reduced independently and concatenated into one aoi_id-keyed parquet with the
    unified component/category schema. Organic soil is a follow-up component."""
    ...
    result_df = afolu_tasks.combine_components(
        [_vegetation_result_df(), _soil_mineral_result_df()]
    )
