...
def dummy_analytics_in():
    return LandCoverCompositionAnalyticsIn(
...
class TestLandCoverCompositionPostUseCaseInitiation:
    @pytest.mark.asyncio
        ...
        assert response.json() == json.loads(
            DataMartResourceLinkResponse(
                data=DataMartResourceLink(
                    link="http://testserver/v0/land_change/land_cover_composition/analytics/e5431188-e85e-5893-8ed7-96baa895e21c"
                ),
