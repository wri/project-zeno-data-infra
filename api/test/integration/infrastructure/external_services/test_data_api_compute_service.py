...
class TestDataApiComputeService:
    ...
    async def test_compute(self):
        data_api_compute_service = DataApiComputeService(api_key=os.environ.get("API_KEY"))
        ...
        assert list(result[0].keys()) == ['iso', 'umd_tree_cover_loss__year', 'umd_tree_cover_loss__ha', 'gfw_gross_emissions_co2e_all_gases__Mg']
